...
/**
 * FinancialInfoScreen provides a comprehensive form for sensitive financial data.
 *
 * This screen is used to demonstrate and test Android Autofill for credit cards and 
 * bank accounts. It properly utilizes Material 3 [Scaffold] and [TopAppBar] with a back navigation.
 *
 * **Sections included:**
 * - **Credit Card Details**: Card number, CVV, expiration date using [ContentType.CreditCardNumber], etc.
 * - **Billing Address**: Street, city, state, zip using [ContentType.AddressStreet], etc.
 * - **Banking Information**: Account holder name, bank name, routing and account numbers.
 *
 * @param onNavigateBack Callback for the back navigation action in the top app bar.
